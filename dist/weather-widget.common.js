...
;// CONCATENATED MODULE: ./src/apiServices/getCitiesWeather.ts


const getCitiesWeather = async cities => {
  const requests = [];
  cities.forEach(city => {
    requests.push(lib_axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${city.cityName}&units=metric&appid=bbb4b95c8c949d4616e5799117279e7f`));
  });
  const weatherData = await Promise.all(requests);
  return weatherData;
};
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-41.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/MainSide.vue?vue&type=script&setup=true&lang=ts
...
/* harmony default export */ var MainSidevue_type_script_setup_true_lang_ts = (/*#__PURE__*/defineComponent({
  __name: 'MainSide',
  emits: ["toggle-view"],
  setup(__props, {
    emit
    ...
    const geoError = reactivity_esm_bundler_ref(false);
    const fetchError = reactivity_esm_bundler_ref(false);
    const cities = reactivity_esm_bundler_ref([]);
    const allCitiesWeather = reactivity_esm_bundler_ref();
    const getWeatherDefaultCity = () => {
      const success = async position => {
        try {
          const data = await lib_axios.get(`https:/api.openweathermap.org/data/2.5/weather?lat=${position.coords.latitude}&lon=${position.coords.longitude}&units=metric&appid=bbb4b95c8c949d4616e5799117279e7f`);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [geoError.value ? (openBlock(), createElementBlock("h3", _hoisted_1, "You need to enable the geolocation setting in the browser")) : createCommentVNode("", true), fetchError.value ? (openBlock(), createElementBlock("h3", _hoisted_2, "Something went wrong! =( Refresh the page and try again.")) : createCommentVNode("", true), (openBlock(true), createElementBlock(runtime_core_esm_bundler_Fragment, null, renderList(allCitiesWeather.value, (weatherData, index) => {
        return openBlock(), createElementBlock("div", {
          class: "container",
          key: weatherData.data.id
        }, [createBaseVNode("div", _hoisted_3, [createBaseVNode("h4", _hoisted_4, toDisplayString(weatherData.data.name) + ", " + toDisplayString(weatherData.data.sys.country), 1), index === 0 ? (openBlock(), createElementBlock("button", {
          key: 0,
          class: "btn",
          onClick: toggleView
        }, _hoisted_6)) : createCommentVNode("", true)]), createBaseVNode("div", _hoisted_7, [createBaseVNode("h1", null, toDisplayString(weatherData.data.main.temp) + "°C", 1), createBaseVNode("img", {
          src: `http://openweathermap.org/img/wn/${weatherData.data.weather[0].icon}@2x.png`
        }, null, 8, _hoisted_8)]), createBaseVNode("p", _hoisted_9, "Feels like " + toDisplayString(weatherData.data.main.feels_like) + " " + toDisplayString(weatherData.data.weather[0].main) + ", " + toDisplayString(weatherData.data.weather[0].description), 1), createBaseVNode("p", null, [createTextVNode("Wind: "), createBaseVNode("i", {
          class: "fa-solid fa-up-long wind-arrow",
          style: normalizeStyle(`transform: rotateZ(${weatherData.data.wind.deg}deg)`)
        }, null, 4), createTextVNode(toDisplayString(weatherData.data.wind.speed) + " m/s", 1)]), createBaseVNode("p", null, "Humidity: " + toDisplayString(weatherData.data.main.humidity) + " %", 1), createBaseVNode("p", null, "Visibility: " + toDisplayString(weatherData.data.visibility), 1)]);
      }), 128))]);
    };
  }
}));
;// CONCATENATED MODULE: ./src/components/MainSide.vue?vue&type=script&setup=true&lang=ts
 
;// CONCATENATED MODULE: ./src/components/MainSide.vue



const __exports__ = MainSidevue_type_script_setup_true_lang_ts;

/* harmony default export */ var MainSide = (__exports__);
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-41.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/SettingsSide.vue?vue&type=script&setup=true&lang=ts



const SettingsSidevue_type_script_setup_true_lang_ts_hoisted_1 = {
  class: "container"
};
const SettingsSidevue_type_script_setup_true_lang_ts_hoisted_2 = /*#__PURE__*/createBaseVNode("h4", {
  class: "city-name"
}, "Settings", -1);
const SettingsSidevue_type_script_setup_true_lang_ts_hoisted_3 = /*#__PURE__*/createBaseVNode("i", {
  class: "fa-solid fa-xmark"
}, null, -1);
const SettingsSidevue_type_script_setup_true_lang_ts_hoisted_4 = [SettingsSidevue_type_script_setup_true_lang_ts_hoisted_3];
const SettingsSidevue_type_script_setup_true_lang_ts_hoisted_5 = {
  class: "city-badge-wrapper"
};
const SettingsSidevue_type_script_setup_true_lang_ts_hoisted_6 = ["draggable", "onDragstart", "onDrop"];
const SettingsSidevue_type_script_setup_true_lang_ts_hoisted_7 = ["onClick"];
const SettingsSidevue_type_script_setup_true_lang_ts_hoisted_8 = ["onSubmit"];
const SettingsSidevue_type_script_setup_true_lang_ts_hoisted_9 = {
...
/* harmony default export */ var SettingsSidevue_type_script_setup_true_lang_ts = (/*#__PURE__*/defineComponent({
  __name: 'SettingsSide',
  emits: ["toggle-view"],
  setup(__props, {
    emit
    ...
    const isDraggable = reactivity_esm_bundler_ref(false);
    const currentCard = reactivity_esm_bundler_ref();
    const cityName = reactivity_esm_bundler_ref("");
    const savedCities = reactivity_esm_bundler_ref(JSON.parse(localStorage.getItem("savedCities") || "[]"));
    ...
    const dragStartHendler = card => {
      currentCard.value = card;
    };
    const dropHendler = card => {
      savedCities.value = savedCities.value.map(c => {
        if (c.id === card.id) {
          return {
            ...c,
            order: currentCard.value.order
          };
        }
    ...
    const removeCity = id => {
      ...
      savedCities.value = cities.filter(c => c.id !== id);
      localStorage.setItem("savedCities", JSON.stringify(savedCities.value));
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", SettingsSidevue_type_script_setup_true_lang_ts_hoisted_1, [createBaseVNode("div", {
        class: "wrapper"
      }, [SettingsSidevue_type_script_setup_true_lang_ts_hoisted_2, createBaseVNode("button", {
        class: "btn",
        onClick: toggleView
      }, SettingsSidevue_type_script_setup_true_lang_ts_hoisted_4)]), createBaseVNode("div", SettingsSidevue_type_script_setup_true_lang_ts_hoisted_5, [createBaseVNode("ul", null, [(openBlock(true), createElementBlock(runtime_core_esm_bundler_Fragment, null, renderList(savedCities.value, city => {
        return openBlock(), createElementBlock("li", {
          key: city.id,
          class: "city-badge",
          draggable: isDraggable.value,
          onDragstart: $event => dragStartHendler(city),
          onDragover: _cache[1] || (_cache[1] = withModifiers(() => {}, ["prevent"])),
          onDrop: withModifiers($event => dropHendler(city), ["prevent"])
        }, [createBaseVNode("i", {
          onMousedown: _cache[0] || (_cache[0] = $event => isDraggable.value = true),
          class: "fa-solid fa-bars burger"
        }, null, 32), createBaseVNode("p", null, toDisplayString(city.cityName), 1), createBaseVNode("i", {
          class: "fa-solid fa-trash remove",
          onClick: $event => removeCity(city.id)
        }, null, 8, SettingsSidevue_type_script_setup_true_lang_ts_hoisted_7)], 40, SettingsSidevue_type_script_setup_true_lang_ts_hoisted_6);
      }), 128))])]), createBaseVNode("form", {
        onSubmit: withModifiers(addCity, ["prevent"]),
        class: "input-wrapper"
      }, [createBaseVNode("div", SettingsSidevue_type_script_setup_true_lang_ts_hoisted_9, [_hoisted_10, withDirectives(createBaseVNode("input", {
        type: "text",
        id: "city",
        placeholder: "City name",
        "onUpdate:modelValue": _cache[2] || (_cache[2] = $event => cityName.value = $event),
        required: ""
      }, null, 512), [[vModelText, cityName.value]])]), _hoisted_11], 40, SettingsSidevue_type_script_setup_true_lang_ts_hoisted_8)]);
    };
  }
}));
;// CONCATENATED MODULE: ./src/components/SettingsSide.vue?vue&type=script&setup=true&lang=ts
 
;// CONCATENATED MODULE: ./src/components/SettingsSide.vue



const SettingsSide_exports_ = SettingsSidevue_type_script_setup_true_lang_ts;

/* harmony default export */ var SettingsSide = (SettingsSide_exports_);
;// CONCATENATED MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-41.use[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/MyApp.ce.vue?vue&type=script&setup=true&lang=ts





/* harmony default export */ var MyApp_cevue_type_script_setup_true_lang_ts = (/*#__PURE__*/defineComponent({
  __name: 'MyApp.ce',
  setup(__props) {
    const settings = reactivity_esm_bundler_ref(false);
    const toggleView = () => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Transition, {
        ...
        default: withCtx(() => [!settings.value ? (openBlock(), createBlock(MainSide, {
          key: 0,
          onToggleView: toggleView
        })) : (openBlock(), createBlock(SettingsSide, {
          key: 1,
          onToggleView: toggleView
        }))]),
        _: 1
...
;// CONCATENATED MODULE: ./src/MyApp.ce.vue?vue&type=script&setup=true&lang=ts
 
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/styleInlineLoader.js!./node_modules/vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-22.use[2]!./node_modules/sass-loader/dist/cjs.js??clonedRuleSet-22.use[3]!./src/assets/main.scss?vue&type=style&index=0&inline&lang=scss&external
/* harmony default export */ var mainvue_type_style_index_0_inline_lang_scss_external = ("@import\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css\";.fade-enter-active,.fade-leave-active{transition:opacity .5s ease}.fade-enter-from,.fade-leave-to{opacity:0}.container{max-width:340px;margin:0 auto;padding:20px;border:1px solid blue;border-radius:1rem;min-height:300px;margin-bottom:10px}ul{list-style:none;padding:0}.wrapper{display:flex;justify-content:space-between;align-items:center}.city-name{margin-bottom:10px}.btn{background:rgba(0,0,0,0);border:none;cursor:pointer}.btn i{font-size:20px}h1{margin-top:10px}.wind-arrow{margin-left:4px;margin-right:10px}.input-label-wrapper{display:flex;flex-direction:column}.input-wrapper{display:flex;gap:0 4px}#city{height:1.5rem}.city-badge-wrapper{margin-bottom:14px}.city-badge{display:flex;align-items:center;justify-content:space-between;padding:4px 10px 4px 10px;height:22px;background-color:#add8e6;margin-bottom:6px;border-radius:6px;-webkit-user-select:none;-moz-user-select:none;user-select:none}.burger{cursor:grab}.submit-btn{background:rgba(0,0,0,0);border:none;cursor:pointer}.submit-btn i{font-size:28px;color:blue;margin-top:16px}.remove{cursor:pointer}");
// EXTERNAL MODULE: ./node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(89);
;// CONCATENATED MODULE: ./src/MyApp.ce.vue
...
const MyApp_ce_exports_ = /*#__PURE__*/(0,exportHelper/* default */.Z)(MyApp_cevue_type_script_setup_true_lang_ts, [['styles',[mainvue_type_style_index_0_inline_lang_scss_external]]])

/* harmony default export */ var MyApp_ce = (MyApp_ce_exports_);
;// CONCATENATED MODULE: ./src/main.ts



customElements.define('weather-widget', defineCustomElement(MyApp_ce));
